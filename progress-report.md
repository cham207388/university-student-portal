...
- Phase 1: implement the persistence-neutral domain and REST contract foundation.
- Add domain types and enforce local state-transition and grade rules with unit tests.
- Add immutable request/response DTOs, Jakarta validation, mapping, pagination contracts, and RFC 9457 error models.
- Define application service and repository ports without DynamoDB or JPA dependencies.
- Add thin controller contracts and MVC tests for validation, status codes, and Problem Details.
