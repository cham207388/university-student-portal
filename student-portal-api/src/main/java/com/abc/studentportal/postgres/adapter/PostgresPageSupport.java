...
abstract class PostgresPageSupport {
    private final PostgresCursorCodec cursors;

    PostgresPageSupport(PostgresCursorCodec cursors) { this.cursors = cursors; }

    <E, D> CursorPage<D> page(String query, CursorRequest request,
