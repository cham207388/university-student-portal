...
public class PostgresStudentQueries extends PostgresPageSupport implements StudentQueries {
    ...
    public PostgresStudentQueries(StudentJpaRepository repository, PostgresCursorCodec cursors) {
    ...
    public CursorPage<Student> findAll(CursorRequest request) {
        ...
        return page("students", request, repository::findAll, PostgresDomainMapper::student);
    }
