...
public class PostgresEnrollmentQueries extends PostgresPageSupport implements EnrollmentQueries {
    ...
    public PostgresEnrollmentQueries(EnrollmentJpaRepository repository, PostgresCursorCodec cursors) {
    ...
    public CursorPage<Enrollment> findAll(CursorRequest request) {
        ...
        return page("enrollments", request, repository::findAll, PostgresDomainMapper::enrollment);
    }
    ...
    public CursorPage<Enrollment> findByStatus(EnrollmentStatus status, CursorRequest request) {
        ...
        return page("enrollments:status:" + status, request, p -> repository.findByStatus(status, p), PostgresDomainMapper::enrollment);
    }
